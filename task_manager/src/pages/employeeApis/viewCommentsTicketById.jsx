...
// //   return (
// //     <div className="flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50 px-4 py-6 min-h-screen">
// //       <div className="w-full max-w-3xl bg-white p-6 sm:p-8 rounded-3xl shadow-2xl border border-gray-200">
// //         {/* Top form */}
// //         <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-6">
// //           View Comments for Ticket
// //         </h2>
...
// //           onChange={(e) => setTicketID(e.target.value)}
// //           placeholder="Enter Ticket ID"
// //           className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400 shadow-sm transition mb-4"
// //         />
...
//         {/* ✅ Comments fixed-height scrollable container */}
//         {comments.length > 0 ? (
//           <div className="mt-6">
//             <h3 className="text-lg sm:text-xl font-semibold mb-4 text-gray-800 border-b pb-2">
//               Comments ({comments.length})
...
//             <div className="h-64 overflow-y-auto pr-2 space-y-4 border rounded-lg p-2 bg-gray-50">
//               {comments.map((comment) => (
//                 <div
//                   key={comment._id}
//                   className="p-4 rounded-xl bg-white border border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 break-words shadow-sm"
//                 >
//                   <div className="flex-1 w-full">
//                     {editingCommentId === comment._id ? (
//                       <div>
...
const ViewCommentsTicketById = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4" style={{ minHeight: '80vh'}}>
      <div className="w-full max-w-xl bg-white p-4 sm:p-6 rounded-2xl shadow-lg border border-gray-200 flex flex-col">
        ...
        {/* Form */}
        <label className="block text-gray-700 font-medium mb-1 text-sm">Ticket ID</label>
        <input
          type="text"
          value={ticketID}
          onChange={(e) => setTicketID(e.target.value)}
